  ...
  <div class="center" id="main">
    ...
    if (isset($_POST["link"])) {
      ...
      if (isset($_POST["remove"])) {
        ...
        unset($linksJson[$fn]);
        unset($clicksJson[$fn]);
        $urlFn = "https://url.ncocdn.cf/" . $fn;

        echo 'Removed Shortened Link: <a href="' . $urlFn . '">' . $urlFn . '</a><br /><br />';
        echo '<button><a href="https://ncocdn.cf/url/" class="nostyle">Shorten Another</a></button>';
      } else {
        ...
        $shortUrl = 'https://url.ncocdn.cf/' . $rand;
...
<div class="footer">Copyright &copy; 2020-2021 Boomaa23. All Rights Reserved.</div>
